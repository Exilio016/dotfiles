...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask .|. shiftMask , xK_Return ), spawn $ "__NV_PRIME_RENDER_OFFLOAD=1 __GLX_VENDOR_LIBRARY_NAME=nvidia alacritty")
  ...
  , ((controlMask .|. mod1Mask , xK_Return ), spawn $ "__NV_PRIME_RENDER_OFFLOAD=1 __GLX_VENDOR_LIBRARY_NAME=nvidia alacritty")
...
, logHook = dynamicLogWithPP $ xmobarPP
              ...
              , ppTitle = xmobarColor "#b3afc2" "" . shorten 35               -- Title of active window
